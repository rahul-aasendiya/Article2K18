...
class Admin extends CI_Controller
{
	...
	public function store_article()
	{
		...
		if ($this->form_validation->run('add_article_rules') && $this->upload->do_upload('fileimage')) {
	...
	public function update_article($article_id)
	{
		...
		if ($this->form_validation->run('add_article_rules')) {
			...
			$this->load->model('articlesmodel','articles');
			return $this->_flashAndRedirect(
						$this->articles->edit_article($article_id,$post),
	...
	private function _flashAndRedirect($sucessful,$successMessage,$failureMessage)
	{
		if ($sucessful) {
